...
public class SurveyController {
	...
	public ModelAndView surveyHome(@RequestParam(name = "id") long courseID, @RequestParam(name = "userID") long userID)
			throws SQLException {
	...
	public ModelAndView addQuestions(@RequestParam(name = "selectedQue") String que,
			@RequestParam(name = "id") long courseID, @RequestParam(name = "userID") long userID) {
		iCreateSurveyModelFactory = CreateSurveyModelFactory.FactorySingleton();
		iCreateSurveyQuestionsModel = iCreateSurveyModelFactory.createSurveyQuestionsModel();
		iListQuestionsService = iCreateSurveyModelFactory.getListQuestionsService();
		iUpdateQuestionsListService = iCreateSurveyModelFactory.getUpdateQuestionsListService();
		ModelAndView mv = new ModelAndView("CreateSurvey/surveyhome");
		iCreateSurveyQuestionsModel = iUpdateQuestionsListService.displayUpdatedQuestionList(
				iCreateSurveyQuestionsModel.getQuestionHeading(), iCreateSurveyQuestionsModel.getQuestionType(), que);
		mv.addObject("publish", false);
		mv.addObject("surveyFlag", true);
		mv.addObject("courseID", courseID);
		mv.addObject("userID", userID);
	...
	public ModelAndView removeQuestions(@RequestParam(name = "removeQue") String que,
			@RequestParam(name = "id") long courseID, @RequestParam(name = "userID") long userID) {
		iCreateSurveyModelFactory = CreateSurveyModelFactory.FactorySingleton();
		iCreateSurveyQuestionsModel = iCreateSurveyModelFactory.createSurveyQuestionsModel();
		iUpdateQuestionsListService = iCreateSurveyModelFactory.getUpdateQuestionsListService();
	...
	@RequestMapping("/save")
	public ModelAndView saveSurvey(@RequestParam(name = "id") long courseID,
	...
	public ModelAndView publishSurvey(@RequestParam(name = "id") long courseID,
			@RequestParam(name = "userID") long userID) {
		iCreateSurveyDBFactory = CreateSurveyDBFactory.FactorySingleton();
		iCreateSurveyDB = iCreateSurveyDBFactory.createSurveyDB();
		int status = 1;
	...
	public ModelAndView unpublishSurvey(@RequestParam(name = "id") long courseID,
			@RequestParam(name = "userID") long userID) {
		iCreateSurveyModelFactory = CreateSurveyModelFactory.FactorySingleton();
		iCreateSurveyQuestionsModel = iCreateSurveyModelFactory.createSurveyQuestionsModel();
		iCreateSurveyDBFactory = CreateSurveyDBFactory.FactorySingleton();
